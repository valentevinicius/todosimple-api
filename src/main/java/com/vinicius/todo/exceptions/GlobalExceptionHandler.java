...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleAllUncaughtException(
        ...
        return buildErrorResponse(
                ...
                request);
    } // Se erro nao foi tratado ainda, retornar erro padrão
    ...
    public ResponseEntity<Object> handleDataIntegrityViolationException(
        ...
        return buildErrorResponse(
                ...
                HttpStatus.CONFLICT,
                request);
    } // Método para tratar erro de dados duplicados (409)
    ...
    public ResponseEntity<Object> handleConstraintViolationException(
        ...
        return buildErrorResponse(
                ...
                request);
    } // Método para tratar erro de valor vazio/incompleto
    ...
    @ResponseStatus(HttpStatus.CONFLICT) // Captura tipo de exceção
    public ResponseEntity<Object> handleDataBindingViolationException(
        ...
        return buildErrorResponse(
                ...
                HttpStatus.CONFLICT, // Status code
                request);
    }
